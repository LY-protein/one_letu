...
window.onload = function () {
    ...
    //var arrow = document.getElementsByClassName("arrow1-a")[0];
    var arrow = ul.nextElementSibling || ul.nextSibling;
    ...
    window.onscroll = function () {
        ...
        aArr[k].className = "current-a";

        //var arrow2 = document.getElementsByClassName("arrow1-a")[0];
        //if(scroll().top < 5000) {
        //    arrow2.className += " arrow-a";
        //}else {
        //    arrow2.className = "arrow1-a";
        //}
