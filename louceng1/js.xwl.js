/**
 * Created by IceWolf on 2016/9/17.
 */
...
$(window).ready(function(){
    ...
    //}
//底部动画
    $(".footer-top-l>dl>dt").on("mouseenter", function () {
        $(this).css({"color":"orange"});
        $(this).siblings().css({"color":"#fff"})
    })
    $(".footer-top-l>dl>dt").on("mouseleave", function () {
        $(this).css({"color":"#999"});
        $(this).siblings().css({"color":"#666"})
    })
    $(".footer-top-l>dl>dd").on("mouseenter", function () {
        $(this).css({"color":"yellow"});
        //$(this).siblings().css({"color":"#fff"})
    })
    $(".footer-top-l>dl>dd").on("mouseleave", function () {
        $(this).css({"color":"#666"});
    })
    $(".xwl-foot-divimg2").on("mouseenter", function () {
        $(this).find(".xwl-foot-img2").stop().hide(1000);
        $(".xwl-foot-img1").stop().show(1000).animate({"right":-75},400);
    })
    $(".xwl-foot-divimg2").on("mouseleave", function () {
        $(this).find(".xwl-foot-img2").stop().show(2000);
        $(".xwl-foot-img1").stop().animate({"right":-45},400).hide(1000);
    })
    $(".xwl-foot-divimgteam").on("mouseenter", function () {
        $(this).find(".img1").stop().animate({"border-bottom-left-radius": 65,"border-top-right-radius": 65,"border-bottom-right-radius": 65,},100).hide(1000)
        $(this).find(".img2").stop().animate({"right":0,"top":0,"border-bottom-left-radius": 20,"border-top-right-radius": 20,"border-bottom-right-radius": 20,},1000)
    })
    $(".xwl-foot-divimgteam").on("mouseleave", function () {
        $(this).find(".img1").stop().show(1000).animate({"border-bottom-left-radius": 0,"border-top-right-radius": 0,"border-bottom-right-radius": 0,},100)
        $(this).find(".img2").stop().animate({"border-bottom-left-radius": 0,"border-top-right-radius": 0,"border-bottom-right-radius": 0,},100).animate({"right":-300,"top":130},1000)
    })
})
