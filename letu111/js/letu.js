$(window).ready(function () {
    $(".footer-r .smallweixin a").mouseenter(function () {
       $(".footer-r .smallweixin .bigweixin").show();
    });
    $(".smallweixin a").mouseleave(function () {
        $(".smallweixin .bigweixin").hide();
    });
    $(".botad .tuiguang").click(function () {
        $(".botad").hide();
    });
    $(".put").mouseenter(function () {
       $(".smallbox").show();
    });
